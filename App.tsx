...
const App: React.FC = () => {
  ...
  return (
    <main
      ref={containerRef}
      className="flex flex-col items-center justify-center h-screen w-full bg-rose-100 p-4 font-serif relative overflow-hidden"
      aria-live="polite">
      {isYesPressed ? (
        <div className="text-center animate-fade-in">
          <img
            src="https://media.tenor.com/gUiu1zyxfzYAAAAi/bear-kiss-bear-kisses.gif"
            alt="Dua beruang kartun berciuman"
            className="h-56 mx-auto rounded-lg shadow-lg"
          />
          <h2 className="text-4xl md:text-5xl font-bold text-rose-700 my-6 tracking-wide">
            Hore! Aku juga cinta kamu! ❤️
          </h2>
        </div>
      ) : (
        <>
          <img
            ...
            alt="Seekor beruang kartun memegang mawar"
            className="h-56 rounded-lg shadow-lg"
          />
          <h1 className="text-3xl md:text-4xl font-bold text-center text-rose-800 my-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mt-4 h-20">
            <button
              ...
              aria-label="Iya, aku mencintaimu">
              IYA
            </button>
            <button
              ref={noButtonRef}
              ...
              aria-label="Tidak, aku tidak mencintaimu"
